...
headModel = Dense(3, activation="softmax")(headModel)  # Change to 3 for three categories
...
# For each image in the testing set we seek to find the index of the label 
